...
import { FloatingIcons } from "../../components/landing-page/floating-icons";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-2xl px-7 pt-16 pb-56 text-center sm:px-6 md:pt-32 md:pb-72">
        ...
        >
                    SkillBridge helps professionals prove what they can actually
          do           through structured assessments, verified profiles, and
