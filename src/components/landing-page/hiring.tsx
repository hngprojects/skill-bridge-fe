...
const talentList = [
  ...
  },
  {
    ...
    img: "https://i.pravatar.cc/150?u=joy",
  },
  {
    name: "Peace John",
    role: "Product Manager",
    img: "https://i.pravatar.cc/150?u=peace",
  },
  {
    name: "Jason Reed",
    role: "DevOps",
    img: "https://i.pravatar.cc/150?u=jason",
  },
  {
    name: "Ruth Chukwu",
    role: "Product Designer",
    img: "https://i.pravatar.cc/150?u=ruth",
  },
  {
    name: "Teo Brown",
    role: "Frontend Dev",
    img: "https://i.pravatar.cc/150?u=teo",
  },
];
...
const TalentPill = ({ person }: { person: (typeof talentList)[0] }) => (
                  ...
                  <div className="relative flex flex-col gap-4 py-4">
                    ...
                    >
                      {[...talentList, ...talentList].map((person, i) => (
                        <TalentPill key={`row1-${i}`} person={person} />
                      ))}
                    </motion.div>
                    <motion.div
                      className="flex w-max gap-4"
                    ...
                    >
                      {[...talentList, ...talentList].map((person, i) => (
                        <TalentPill key={`row2-${i}`} person={person} />
                      ))}
                    </motion.div>
                    <motion.div
                      className="flex w-max gap-4"
                    ...
                    >
                      {[...talentList, ...talentList].map((person, i) => (
                        <TalentPill key={`row3-${i}`} person={person} />
                      ))}
                    </motion.div>
